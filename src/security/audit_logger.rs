...
impl AuditLogger {
    ...
    pub async fn log_wallet_access(&self, action: &str, success: bool, user_id: Option<&str>) -> Result<()> {
    ...
    /// Log login attempt
    pub async fn log_login_attempt(&self, user_id: &str, success: bool, ip_address: Option<&str>) -> Result<()> {
        let severity = if success {
            AuditSeverity::Info
        } else {
            AuditSeverity::Warning
    ...
    pub async fn log_config_change(&self, config_key: &str, old_value: &str, new_value: &str, user_id: Option<&str>) -> Result<()> {
        let event_data = serde_json::json!({
    ...
    /// Log system error
    pub async fn log_system_error(&self, error_message: &str, error_code: Option<&str>) -> Result<()> {
        let event_data = serde_json::json!({
